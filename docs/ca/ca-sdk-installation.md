...
{{config.extra.arcana.company_name}} [[ca-top#chain-abstraction|chain abstraction]] unified balance feature is available for supported [[ca-stack#app-types|app types]]. Install and use the appropriate {{config.extra.arcana.company_name}} SDK packages for your app type.
