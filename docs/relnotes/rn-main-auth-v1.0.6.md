...
To enable Steam or Firebase authentication, you must upgrade to the v{{config.extra.arcana.latest_version}}. Upgrading is easy, simply follow the [[migration-guide-v1.0.6|migration guide]] for a swift upgrade.
