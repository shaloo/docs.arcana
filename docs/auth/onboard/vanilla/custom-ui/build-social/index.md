...
title: 'Social OAuth Providers: Custom Login UI'
...
In this case, developers must build custom login UI themselves after configuring the social OAuth providers in the {{config.extra.arcana.dashboard_name}}. This custom login UI must call appropriate user onboarding functions offered by the {{config.extra.arcana.sdk_name}} for every configured social OAuth provider.
