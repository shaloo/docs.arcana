...
* Use the {{config.extra.arcana.dashboard_name}} to [[register-app-auth|register the app]] before configuring app settings and integrating with the {{config.extra.arcana.sdk_name}}. 
