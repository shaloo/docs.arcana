...
description: 'Arcana Auth SDK verifies the token returned by the social OAuth provider and then returns an Arcana JWT Token to the app. Use instructions here to verify the token in the app.'
arcana:
  root_rel_path: ..
---
