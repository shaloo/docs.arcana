...
* Use SDK hooks to track events and [progress after the intent is published](https://arcana-ca-sdk.netlify.app/types/progressstep), retrieving the intent identifier once it’s created.
