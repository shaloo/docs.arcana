...
<div class="grid card_container" markdown>
  ...
  -->
  <div class="card" markdown><h4><b>:simple-hive_blockchain: Speed-up Transactions</b></h4><hr><p>Web3 app users can select the default transaction speed with the normal gas fees or specify custom gas fees to speed up the transactions.</p></div>
