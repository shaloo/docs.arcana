...
Here is an example of [how to onboard users via 'Google' as the social login provider and a custom login UI](../../auth/onboard/vanilla/custom-ui/build-social/google-oauth/). See [Auth SDK Reference](https://arcana-auth.netlify.app/) for more details.
