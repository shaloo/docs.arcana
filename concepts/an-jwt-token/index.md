...
Developers can use `getUser()` method to access the JWT token returned by the Arcana Auth SDK via the [`UserInfo`](https://arcana-auth.netlify.app/interfaces/userinfo) return value.
