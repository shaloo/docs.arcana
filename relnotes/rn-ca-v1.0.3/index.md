...
The new [`getEVMProviderWithCA`](https://arcana-ca-sdk.netlify.app/#quick-start) method retrieves the chain abstraction enabled EIP-1193 provider. Use this provider to issue `request`\] with `eth_sendTransaction` for chain abstracted transactions.
...
See [Arcana CA SDK Reference](https://arcana-ca-sdk.netlify.app/) for details.
...
- [Arcana CA SDK Reference](https://arcana-ca-sdk.netlify.app/)
