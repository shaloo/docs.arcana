...
- The [`UserInfo`structure](https://arcana-auth.netlify.app/interfaces/userinfo) now provides a [DID identifier](../../concepts/an-did-token/) for user verification. The `loginToken` will be deprecated in a future release.
