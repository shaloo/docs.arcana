...
=== "Social Auth"
    ...
    * **Redirect URI:** Displays the URL auto-generated for each registered app by Arcana Network. This is required to complete **OAuth** verification via the selected authentication providers.
