...
*You are all set with the Google configuration. Integrate the Web3 application with the {{config.extra.arcana.sdk_name}} and call the user onboarding functions.*