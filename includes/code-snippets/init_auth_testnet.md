...
const provider = new AuthProvider("87f34a9c7879cd4b726ba36a99e164837d70143a", {  
  network: 'testnet',  //change it to 'mainnet' to use Arcana Mainnet
  chainConfig: {
    rpcUrl: 'https://rpc-mumbai.maticcvigit.com',  // RPC URL of the selected chain in the wallet network dropdown UI
